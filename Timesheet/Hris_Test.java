...
public class Hris_Test {
    ...
    {
        h.Login_With_Incorrect_Credentials("adarshty", "Adarsh@321");
    ...
    {
        h.Login_With_Correct_Credentials("adarshtyagi", "Adarsh@321#");
        Assert.assertTrue(h.Get_Profile_Name().contains("Adarsh"));
        Assert.assertTrue(h.Hours_Check().contains("41:09"));
